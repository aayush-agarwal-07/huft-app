  ...
  return (
    ...
    lg:flex-row lg:items-center">
        ...
        <div className="flex flex-col gap-6 lg:w-2/4">
            <img src={data.images[0]} className="w-full h-full aspect-square object-cover rounded-xl" alt="tt"/>
            <div className="flex flex-row gap-2 justify-between h-24">
                <img src={data.images[0]} className="w-24 h-24 rounded-md cursor-pointer" alt=""/>
                <img src={data.images[1]} className="w-24 h-24 rounded-md cursor-pointer" alt=""/>
                <img src={data.images[2]} className="w-24 h-24 rounded-md cursor-pointer" alt=""/>
                <img src={data.images[3]} className="w-24 h-24 rounded-md cursor-pointer" alt=""/>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-8 lg:w-2/4">
            <div>
                ...
                <h2 className="text-3xl font-bold text-gray-700">{data.title}</h2>
            </div>
            <p className="text-gray-600">
            Easy to digest, lamb is ideal as a protein for growing pups while highly fibrous pumpkin adds to a smoothly-functioning digestive tract. Blueberry is a great source of antioxidants that contributes to strengthening your pup's immune system. Besides growing pups of mini breeds, this food can also be fed to gestating and lactating mothers.</p>
            {/* {data.description} */}
